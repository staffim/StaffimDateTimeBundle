...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'staffim_datetime.date_time_handler' => 'getStaffimDatetime_DateTimeHandlerService',
            'staffim_datetime.timestampable_subscriber' => 'getStaffimDatetime_TimestampableSubscriberService',
    ...
    /**
     * Gets the 'staffim_datetime.date_time_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Staffim\DateTimeBundle\Serializer\DateTimeHandler A Staffim\DateTimeBundle\Serializer\DateTimeHandler instance.
     */
    protected function getStaffimDatetime_DateTimeHandlerService()
    {
        return $this->services['staffim_datetime.date_time_handler'] = new \Staffim\DateTimeBundle\Serializer\DateTimeHandler();
    }

    /**
     * Gets the 'staffim_datetime.timestampable_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Staffim\DateTimeBundle\Event\TimestampableSubscriber A Staffim\DateTimeBundle\Event\TimestampableSubscriber instance.
     */
    protected function getStaffimDatetime_TimestampableSubscriberService()
    {
        return $this->services['staffim_datetime.timestampable_subscriber'] = new \Staffim\DateTimeBundle\Event\TimestampableSubscriber();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56f45d749c4bb1.23312877')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'StaffimDateTimeBundle' => 'Staffim\\DateTimeBundle\\StaffimDateTimeBundle',
            ),
            ...
            'staffim_datetime.timestampable_subscriber.class' => 'Staffim\\DateTimeBundle\\Event\\TimestampableSubscriber',
            'staffim_datetime.date_time_handler.class' => 'Staffim\\DateTimeBundle\\Serializer\\DateTimeHandler',
